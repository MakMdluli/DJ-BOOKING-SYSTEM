...
function nav(){return `<div class="admin-head"><a href="../index.html"><img class="logo" src="../assets/logo.png" alt="Scorpion_Jr"></a><div><span class="eyebrow">ADMIN PANEL</span><div class="admin-title">Scorpion_Jr Booking System</div></div></div><nav class="admin-nav"><a href="dashboard.html">Dashboard</a><a href="bookings.html">Bookings</a><a href="calendar.html">Calendar</a><a href="clients.html">Clients</a><a href="packages.html">Packages</a><a href="payments.html">Payments</a><a href="invoices.html">Invoices</a><a href="setlists.html">Setlists</a><a href="reviews.html">Reviews</a><a href="settings.html">Settings</a><a href="#" onclick="adminSignOut();return false;">Sign out</a></nav>`;}
